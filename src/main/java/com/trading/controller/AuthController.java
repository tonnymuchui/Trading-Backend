...
//		walletService.createWallet(user);
    ...
    @PostMapping("/signin")
    public ResponseEntity<AuthResponse> signing(@RequestBody LoginRequest loginRequest) throws ExecutionControl.UserException, MessagingException, UserException {
